...
import { MessageSquare, Search, UserCheck, Phone, CheckCircle2 } from "lucide-react";
import { processSteps } from "@/lib/constants";
import { Container } from "@/components/ui/Container";
import { SectionHeading } from "@/components/ui/SectionHeading";

const stepIcons = [MessageSquare, Search, UserCheck, Phone, CheckCircle2];
    ...
    <section id="how-it-works" className="relative py-24 lg:py-32 bg-white">
      <Container>
        <SectionHeading
          ...
          title="Get Expert Help in 5 Simple Steps"
          description="From requirement to delivery — our platform makes finding the right CA effortless."
        />
        ...
        >
          <a
            href="#lead-form"
            className="inline-flex items-center gap-2 rounded-xl bg-accent px-8 py-4 font-semibold text-primary hover:bg-accent-light transition-colors"
          >
